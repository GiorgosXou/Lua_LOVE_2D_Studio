...
namespace FastColoredTextBoxNS
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        public readonly Style BlueBoldStyle = new TextStyle(new SolidBrush(Color.FromArgb(0, 43, 116)), null, FontStyle.Regular );
        ...
        public readonly Style MagentaStyle = new TextStyle(Brushes.SlateBlue, null, FontStyle.Regular);
        public readonly Style MaroonStyle = new TextStyle(Brushes.Maroon, null, FontStyle.Regular);
        public readonly Style RedStyle = new TextStyle(Brushes.Red, null, FontStyle.Regular);
        public readonly Style Green2style = new TextStyle(Brushes.SeaGreen, null, FontStyle.Regular); // G.X
        public readonly Style SaddleBrownStyle = new TextStyle(Brushes.SaddleBrown, null, FontStyle.Regular); // G.X
        ...
        protected Regex VBSpecial;
        protected Regex VBSpecial2;
        ...
        protected void VBAutoIndentNeeded(object sender, AutoIndentEventArgs args)
        {
            ...
            if (Regex.IsMatch(args.LineText,
                              @"\b(Class|Property|Enum|Event|Structure|Sub|Function|Namespace|Interface|Get)\b|(Set\s*\()",
        ...
        public void InitStyleSchema(Language lang)
        {
            switch (lang)
            {
                ...
                case Language.VB:
                    ...
                    ClassNameStyle = BoldStyle;
                    KeywordStyle = BlueStyle;
                    SpecialWordstyle = Green2style; // G.X
                    SpecialWordstyle1 = SaddleBrownStyle; // G.X
                    break;
                case Language.HTML:
                    CommentStyle = GreenStyle;
...
";
        ...
        protected void InitVBRegex()
        {
            ...
            VBClassNameRegex = new Regex(@"\b(ICANT3HAVE4THIS6NOTHING2SO234FUCK234)[ ]+(?<range>\w+?)\b", // BOLD FORM1
            ...
            VBKeywordRegex =
                new Regex(
                    ...
                    RegexOptions.IgnoreCase | RegexCompiledOption);
            VBSpecial = new Regex(
                    @"\b(Application|Arrays|Statistics|Files|Math|Matrix|AcceleromaterSenor|LocationSensor|OrientationSensor|Phone|Component|Dates|Strings|Conversions|)\b",
                    RegexOptions.IgnoreCase | RegexCompiledOption);
            VBSpecial2 = new Regex(
                    @"\b(Base64|)\b",
                    RegexOptions.IgnoreCase | RegexCompiledOption);
        }
...
";
        ...
        public Style SpecialWordstyle1 { get; set; } // G.X

        public Style SpecialWordstyle { get; set; } //G.X
        /// <summary>
